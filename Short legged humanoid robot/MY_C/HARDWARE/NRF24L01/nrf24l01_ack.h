...
#ifndef __nRF24L01_ACK_H
#define __nRF24L01_ACK_H
...
//==============================
//控制管脚
	#define GPIO_PORT_nRF              		GPIOB
	#define RCC_APB2Periph_GPIO_nRF   		RCC_APB2Periph_GPIOB
	#define GPIO_Pin_nRF_CE            		GPIO_Pin_4
	
	#define GPIO_PORT_nRF_SPI				GPIOB
	#define RCC_APB2Periph_GPIO_nRF_SPI		RCC_APB2Periph_GPIOB 
	#define GPIO_Pin_nRF_nCS           		GPIO_Pin_12
	#define GPIO_Pin_nRF_SCK				GPIO_Pin_13
	#define GPIO_Pin_nRF_MOSI				GPIO_Pin_15
	#define GPIO_Pin_nRF_MISO				GPIO_Pin_14
	
	#define GPIO_PORT_nRF_IRQ				GPIOB
	#define RCC_APB2Periph_GPIO_nRF_IRQ		RCC_APB2Periph_GPIOB
	#define GPIO_Pin_nRF_IRQ           		GPIO_Pin_5

	#define CE_H()		( HAL_GPIO_WritePin(GPIOB,GPIO_PIN_11,GPIO_PIN_SET)  )
	#define CE_L()		( HAL_GPIO_WritePin(GPIOB,GPIO_PIN_11,GPIO_PIN_RESET))
	#define CSN_H()		( HAL_GPIO_WritePin(GPIOB,GPIO_PIN_10,GPIO_PIN_SET)	 )
	#define CSN_L()		( HAL_GPIO_WritePin(GPIOB,GPIO_PIN_10,GPIO_PIN_RESET))
	#define nRF_IRQ() (GPIOB->IDR&(1<<12))
//==============================
//nRF24L01寄存器操作命令
...
//24L01发送接收数据宽度定义
	...
	#define nRF_RX_CONFIG		0x3f, 0x3f, 0x82, 40, 0x26, 0x0f
	//发射机,ACK 应答通道0,接收通道0,间隔250*4=1ms,2次,速率250K,0db,校验9位,发送模式
	#define nRF_TX_CONFIG		0x01, 0x01, 0x82, 40, 0x26, 0x0e
//==============================
	...
	#endif
	#endif
	#define nRF_TX_Channel		3//发送通道号(相对于接收机的接收通道号)
